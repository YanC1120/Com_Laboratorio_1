...
class Demulador_FM(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "Demulador_FM_J1A", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("Demulador_FM_J1A")
        ...
        self.settings = Qt.QSettings("GNU Radio", "Demulador_FM")
...
def main(top_block_cls=Demulador_FM, options=None):
