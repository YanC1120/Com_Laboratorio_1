...
class Compara(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "Compara")
        ...
        # Blocks
        ##################################################
        self._Of_range = Range(-2, 2, 0.01, 0, 200)
        self._Of_win = RangeWidget(self._Of_range, self.set_Of, "Offest", "counter_slider", float, QtCore.Qt.Horizontal)
        self.top_layout.addWidget(self._Of_win)
        self._AM_range = Range(-2, 2, 0.01, 0, 200)
        self._AM_win = RangeWidget(self._AM_range, self.set_AM, "Am", "counter_slider", float, QtCore.Qt.Horizontal)
        self.top_layout.addWidget(self._AM_win)
        self._A_range = Range(0, 2, 0.01, 2, 200)
        ...
        self.analog_sig_source_x_0_0 = analog.sig_source_f(samp_rate, analog.GR_SAW_WAVE, 10000, 2*A, -A+Of, 0)
        ...
        self.connect((self.blocks_throttle_0, 0), (self.ModulosEfren_Compara_0, 1))
    ...
    def set_Of(self, Of):
        self.Of = Of
        self.analog_sig_source_x_0_0.set_offset(-self.A+self.Of)
...
def main(top_block_cls=Compara, options=None):
