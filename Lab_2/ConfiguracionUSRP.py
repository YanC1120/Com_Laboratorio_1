...
class ConfiguracionUSRP(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self._fc_win = RangeWidget(self._fc_range, self.set_fc, "Frecuencia Portador", "counter_slider", float, QtCore.Qt.Horizontal)
        self.top_layout.addWidget(self._fc_win)
        self._G_range = Range(0, 30, 1, 0, 200)
        ...
        self._A_range = Range(0, 1, 1e-3, 1, 200)
        ...
        self.uhd_usrp_sink_0.set_gain(G, 0)
    ...
    def set_G(self, G):
        self.G = G
        self.uhd_usrp_sink_0.set_gain(self.G, 0)
