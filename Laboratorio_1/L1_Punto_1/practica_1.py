...
class practica_1(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        gr.top_block.__init__(self, "Simple Rate demo")
        Qt.QWidget.__init__(self)
        self.setWindowTitle("Simple Rate demo")
        ...
        self._freq_win = RangeWidget(self._freq_range, self.set_freq, 'Frecuencia Señal', "counter_slider", float)
